...
export const metadata: Metadata = {
  title: 'Unit Converters - Length, Weight, Temperature, Currency | SuperCalc',
  description: 'Free unit converters for length, weight, temperature, currency, speed, area, and volume.',
};

export default function UnitConverters() {
  const tools = getToolsByCategory('converter');
  const category = categories.find(c => c.id === 'converter');
